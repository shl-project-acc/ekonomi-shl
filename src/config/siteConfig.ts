...
export const siteConfig: SiteConfig = {
	...
	// 站点副标题
	subtitle: "Dari Ilmu ke Amal, Dari Teori ke Praktik",

	// 站点 URL
	site_url: "https://ekonomi-shl.shlprojectbusiness.workers.dev/",

	// 站点描述
	description:
		"A modern personal blog built with Astro, focusing on economics and technology",
	...
	navbar: {
		...
		logo: {
			type: "image",
			value: "assets/images/logo-shl-project.webp",
			alt: "🍀",
		},
		// 导航栏标题
		title: "SHL PROJECT",
